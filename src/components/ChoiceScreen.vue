...
const symbols = [
    ...
    {
        name: "Five Sided Die",
        image: "/public/img/Five-Sided_Die.png",
        rarity: "Uncommon",
        description: "Gives between Coin 1 and Coin 5 randomly."
    },
    {
        name: "Anchor",
        image: "/public/img/Anchor.png",
        rarity: "Common",
        ...
        <div class="grid grid-cols-4 gap-4 p-4">
            ...
            <div class="flex flex-col p-3 border-2 border-black max-w-72 gap-4"
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <img src="/public/img/Coffee_Essence.png" />
